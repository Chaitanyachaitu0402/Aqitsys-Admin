...
const Navbar = (props) => {
  ...
  return (
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
      ...
      <div className="relative mt-[3px] flex h-[61px] items-center gap-4 rounded-full bg-white px-4 py-2 shadow-xl dark:!bg-navy-800 w-fit">
      ...
      <div className="flex w-56 flex-col rounded-[20px] bg-white shadow-xl dark:!bg-navy-700 dark:text-white">
        ...
        <div className="flex flex-col p-4">
          <button
            ...
            className="mt-3 text-left text-sm font-medium text-red-500 hover:text-red-600 transition duration-150"
          >
            Log Out
          </button>
        </div>
